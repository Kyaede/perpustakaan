...
<div class="container mx-auto">
    ...
    <div class="flex justify-center min-h-screen dark::bg-gray-900">
        <div class="col-span-12">
            <a href="{{ route('pinjam.create') }}"><button class="bg-indigo-600 text-white py-2 px-8 rounded-lg position-relative">New Data</button></a>
                    ...
                    @endphp
                        ...
                        <tr class="bg-gray-800">
                            ...
                            <td class="p-3 ">
                                ...
                                <a href="{{ route('pinjam.edit',['pinjam' => $pinjams->peminjaman_id]) }}" class="text-gray-400 hover:text-gray-100  mx-2">
                                    <i class="material-icons-outlined text-base">edit</i>
                                </a>
                                <form action="{{ route('pinjam.destroy', $pinjams->peminjaman_id) }}" method="POST" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
